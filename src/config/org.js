...
export const ORG = [
  ...
  {
    name: "Nedelcu Alexandru",
    email: "alexandru.n@crystal-logistics-services.com",
  ...
  {
    name: "David Popescu",
    email: "david.p@crystal-logistics-services.com",
