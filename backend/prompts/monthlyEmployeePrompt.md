...
PPentru Freight Forwarder (Operațional) se aplică regula orientativă a distribuției 50/50 a profitului: minimum 50% din profit ar trebui generat din activitatea de Dispecer Principal (clienți proprii și ofertare pe Timocom/Trans.eu) și minimum 50% din activitatea de Dispecer Secundar (colaborare cu Sales).Dacă peste 70% din profit provine din rolul de Dispecer Principal, acest lucru nu reprezintă o problemă, însă se recomandă explorarea și dezvoltarea colaborărilor cu departamentul de Vânzări sau cu alți colegi din operațional, pentru diversificarea surselor de profit.În schimb, dacă peste 70% din profit provine exclusiv din rolul de Dispecer Secundar, este necesar un focus crescut pe dezvoltarea portofoliului propriu de clienți și pe ofertarea activă în burse. Lipsa totală a curselor generate din burse constituie o alertă critică.
...
- Se include DOAR dacă performanța este sub 80% din target.
- Dacă performanța este 80% sau peste, NU include deloc această cheie în JSON (nici ca obiect gol).
