...
Structura Raport Departamental:
{
  ...
  "sectiunea_2_analiza_vanzari": {
    ...
    "targetDepartamental": {
  	"target": "[valoare] EUR (suma targetelor individuale)",
