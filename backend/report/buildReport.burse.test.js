        ...
        items: [
          {
            ...
            column_values: [
              ...
              { id: COLS_COMENZI.VALOARE_CLIENT, value: JSON.stringify(510) },
            ],
          },
          {
            ...
            column_values: [
              ...
              { id: COLS_COMENZI.VALOARE_CLIENT, value: JSON.stringify(999) },
            ],
          },
        ],
      },
        ...
        items: [
          {
            column_values: [
              ...
              { id: COLS_COMENZI.MONEDA, text: 'EUR' },
              { id: COLS_COMENZI.PROFIT, value: JSON.stringify(200) },
              { id: COLS_COMENZI.VALOARE_CLIENT, value: JSON.stringify(200) },
            ],
          },
        ],
      },
